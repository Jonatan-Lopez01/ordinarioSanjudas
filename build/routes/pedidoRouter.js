...
class PedidoRouter {
    ...
    config() {
        ...
        this.router.get('/obtenerMayorPedidoId/', pedidoController_1.pedidoController.obtener_mayor_pedido_id);
        ...
        this.router.get('/pedidos/total/tabla/calculo/total', pedidoController_1.pedidoController.mostrar_total_pedidos);
