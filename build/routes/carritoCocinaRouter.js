...
class CarritoCocinaRouter {
    ...
    config() {
        ...
        this.router.delete('/eliminarPlatilloCocinaByIdCarrito/:CarritoId', carritoCocinaController_1.carritoCocinaController.eliminar_platillo_cocina_by_idCarrito);
        ...
        this.router.get('/buscarPlatilloIdCarrito/:idCarrito', carritoCocinaController_1.carritoCocinaController.buscar_platillo_by_IdCarrito);
    }
}
